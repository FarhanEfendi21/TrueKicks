      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 font-poppins transition-colors duration-300">
        ...
        {showEditModal && (
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl w-full max-w-sm p-5 sm:p-6 shadow-xl max-h-[85vh] overflow-y-auto">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 sticky top-0 bg-white z-10 pb-2">Edit Profile</h3>
              ...
              <div className="flex gap-2 mt-6 sticky bottom-0 bg-white pt-2 pb-1">
                <button
