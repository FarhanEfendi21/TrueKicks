...
const AnimatedImage = ({ src, alt, className }) => {
  ...
  return (
    <img
      ...
      src={src}
      alt={alt}
      // Gabungkan className bawaan dengan class animasi
...
export default function Home() {
  ...
  // Ref untuk Carousel Top Picks
  const scrollRef = useRef(null);
  // Ref untuk Section yang akan dituju
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 lg:mb-16 space-y-6">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-5 py-2 rounded-full shadow-lg shadow-orange-500/30 animate-fade-in-down">
              ...
              <span className="text-xs font-bold tracking-wider uppercase">Limited Collection 2025</span>
            </div>
            ...
            <p className="text-gray-600 text-sm sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed font-medium px-4">
              Explore the most exclusive sneaker collection with authentic quality and cutting-edge design.
            </p>
          ...
          {/* ========================================================
              ...
              ======================================================== */}
          <div className="lg:hidden w-full mt-10 mb-4 overflow-hidden"> {/* Tambahkan overflow-hidden disini */}
             ...
             <div className="relative w-full bg-black -rotate-2 py-2 mb-8 shadow-lg border-y-2 border-yellow-400 overflow-hidden">
                ...
                <div className="flex w-max animate-marquee">
                   ...
                   <div className="flex gap-8 items-center text-white font-black italic tracking-widest text-sm px-4">
                      <span>NIKE</span> ✦ <span>ADIDAS</span> ✦ <span>NEW BALANCE</span> ✦ <span>PUMA</span> ✦ <span>ASICS</span> ✦ <span>NIKE</span> ✦ <span>ADIDAS</span> ✦ <span>NEW BALANCE</span>
                   </div>
             ...
             <div className="grid grid-cols-3 gap-2 px-4">
                ...
                <div className="bg-white/60 backdrop-blur p-3 rounded-xl text-center border border-gray-100 shadow-sm">
                    ...
                    <p className="text-[10px] font-bold text-gray-600 uppercase">Free Ship</p>
                </div>
                <div className="bg-white/60 backdrop-blur p-3 rounded-xl text-center border border-gray-100 shadow-sm">
                    <div className="text-xl mb-1">🛡️</div>
                    <p className="text-[10px] font-bold text-gray-600 uppercase">Authentic</p>
                </div>
                <div className="bg-white/60 backdrop-blur p-3 rounded-xl text-center border border-gray-100 shadow-sm">
                    <div className="text-xl mb-1">↩️</div>
                    <p className="text-[10px] font-bold text-gray-600 uppercase">Returns</p>
                </div>
             </div>
          ...
          <div className="hidden lg:flex relative w-full h-[700px] items-center justify-center mt-8">
              ...
              <div className="relative bg-white/95 backdrop-blur-xl p-6 rounded-3xl shadow-2xl border border-white/50 w-72 transform transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex text-orange-500 text-sm">{'★'.repeat(5)}</div>
                    <span className="text-sm font-bold text-gray-700">(4.9)</span>
                    <span className="text-xs text-gray-400 ml-auto">2.1K reviews</span>
                  </div>
                ...
                <svg className="absolute top-1/2 -left-32 w-36 h-24 text-orange-500/80 pointer-events-none" viewBox="0 0 150 80" fill="none">
                  <path d="M 145 15 Q 100 15, 80 40 T 10 55" stroke="currentColor" strokeWidth="2.5" strokeDasharray="6 4" strokeLinecap="round" className="animate-pulse"/>
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-3 justify-center">
              <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/50 text-xs font-bold text-gray-700">✓ Authentic Product</div>
              <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/50 text-xs font-bold text-gray-700">✓ Free Shipping</div>
              <div className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/50 text-xs font-bold text-gray-700">✓ 30 Days Return</div>
            </div>
          </div>
      ...
      <section className="hidden md:block py-10 border-y-2 border-gray-200/50 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex justify-around items-center gap-16 sm:gap-20 overflow-x-auto no-scrollbar opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
            <img src={nikeLogo} alt="Nike Logo" className="h-20 sm:h-20 md:h-20  flex-shrink-0" />
            <img src={adidasLogo} alt="Adidas Logo" className="h-7 sm:h-9 md:h-12 flex-shrink-0" />
            <img src={newBalanceLogo} alt="New Balance Logo" className="h-20 sm:h-20 md:h-20 flex-shrink-0" />
            <img src={pumaLogo} alt="Puma Logo" className="h-7 sm:h-9 md:h-12 flex-shrink-0" />
            <img src={converseLogo} alt="Converse Logo" className="h-20 sm:h-20 md:h-20  flex-shrink-0" />
          </div>
        </div>
      </section>
...
{/* ===========================
      ...
      <section className="md:hidden py-6 border-b border-gray-100 bg-white">
        <div className="px-4">
           <h3 className="text-xs font-black text-gray-400 uppercase tracking-widest mb-3">Browse by Category</h3>
           ...
           <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
              {[
                ...
                <button
                  key={cat.name}
                  onClick={() => navigate('/sneakers', { state: { typeFilter: cat.name } })} // Langsung filter ke halaman sneakers
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-lg">
            <div className="flex items-center gap-2 mb-2">
               ...
               <span className="text-orange-600 font-bold text-sm tracking-widest uppercase">Curated Collection</span>
            </div>
            ...
            <p className="text-gray-500 mt-4 text-lg">
              The most sought-after silhouettes of the season, handpicked for your style.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-gray-700 group-hover:text-white transition-colors"><path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" /></svg>
            </button>
            <button 
              onClick={() => scroll('right')} 
              className="group w-14 h-14 rounded-full border border-gray-200 bg-white flex items-center justify-center hover:bg-black hover:border-black transition-all duration-300 shadow-sm hover:shadow-xl"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-gray-700 group-hover:text-white transition-colors"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>
            </button>
          </div>
        </div>

        {/* Carousel Container */}
        <div ref={scrollRef} className="flex gap-8 overflow-x-auto no-scrollbar snap-x snap-mandatory pb-12 pt-4 scroll-smooth px-4">
          {loading && topPicks.length === 0 ? (
             [...Array(3)].map((_, i) => <div key={i} className="min-w-[300px] h-[400px] bg-gray-100 rounded-[2rem] animate-pulse flex-shrink-0"></div>)
          ) : (
            topPicks.map((item, index) => (
              <div key={item.id} className="min-w-[300px] md:min-w-[340px] snap-center flex-shrink-0 group">
                ...
                */}
                ...
                >
                  ...
                  <div>
                    ...
                    {/* Content */}
                    <div className="px-2">
                       <p className="text-orange-500 text-xs font-bold uppercase tracking-wider mb-1">{item.category}</p>
                  ...
                  <div className="px-2 pt-4 flex items-center justify-between border-t border-dashed border-gray-100 mt-2">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-gray-400 font-medium uppercase">Current Price</span>
                    ...
                    <button className="relative overflow-hidden w-12 h-12 bg-gray-900 text-white rounded-2xl flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300 shadow-lg shadow-gray-900/20 group-hover:shadow-orange-500/40">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5 relative z-10"><path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" /></svg>
                    </button>
                  </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-purple-600 font-bold text-sm tracking-widest uppercase">Just Dropped</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-none">
              FRESH <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500">KICKS.</span>
            </h2>
          </div>
               ...
               */
               ...
               >
                 ...
                 <div className="relative h-[220px] bg-gradient-to-br from-[#F8FAFC] to-[#F1F5F9] rounded-[1.5rem] flex items-center justify-center mb-5 overflow-hidden group-hover:from-purple-50 group-hover:to-white transition-colors duration-500">
                   ...
                   <div className="absolute top-4 left-4 z-20">
                     <div className="bg-white/80 backdrop-blur-md px-3 py-1.5 rounded-full shadow-sm border border-white/50 flex items-center gap-1.5">
                       ...
                       <span className="text-[10px] font-bold text-gray-800 tracking-wider uppercase">New</span>
                     </div>
                   </div>
                 ...
                 <div className="px-2 pb-2">
                   <p className="text-xs font-bold text-gray-400 mb-1 uppercase tracking-wide">{item.category}</p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex items-center justify-between mb-4 px-2">
            <div className="flex items-center gap-2">
               ...
               <span className="text-xs font-bold tracking-widest text-gray-500 uppercase">Limited Time Offer</span>
            </div>
            <span className="text-xs font-medium text-gray-400">Ends in 24h</span>
          </div>
          ...
          <div className="mt-4 text-center opacity-30">
             <p className="text-[10px] tracking-[0.5em] font-black uppercase">TrueKicks Original</p>
          </div>
        </div>
      </section>
      ...
      {blackCollection.length > 0 && (
        <section ref={blackCollectionRef} className="max-w-7xl mx-auto px-6 mb-32 scroll-mt-24">
           {/* Section Header */}
           <div className="mb-16 text-center relative">
             ...
             <div className="relative z-10">
                <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tighter uppercase mb-3">
                  The <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-black">Dark Side</span>
                </h2>
                <div className="h-1 w-24 bg-black mx-auto rounded-full mb-4"></div>
                <p className="text-gray-500 font-medium text-lg">Stealth mode activated. Essential black rotation.</p>
             </div>
           </div>
